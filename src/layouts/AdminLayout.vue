...
<script setup>
import { FwbSidebar, FwbSidebarItem, FwbButton } from 'flowbite-vue'
import { ref } from 'vue'

const openSidebarButton = ref(true)
...
const { role, user, loading } = storeToRefs(userAuthStore());
    ...
    <div class="bg-gray-100">
        ...
        <div class="h-auto flex">
            ...
            <div :class="openSidebarButton ? '-translate-x-full' : ''"
                class="fixed lg:block z-50 bg-gray-50 text-white w-64 min-h-screen overflow-y-auto transition-transform transform  ease-in-out duration-300"
                id="sidebar">
                ...
                <div>
                    <div class="h-screen px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                        <ul class="space-y-2 font-medium">
                            <router-link :to="{ name: 'dashboard' }">
                                <li>
                                    ...
                                    <span
                                        ...
                                        <span class="ms-3">{{ role == 1 ? 'admin' : 'teacher' }}</span>
                                    </span>
                                </li>
                            </router-link>
                            <div v-if="userAuthStore().role == 1">
                                ...
                                <li>
                                    <router-link :to="{ name: 'promos' }"
                                        ...
                                        <span class="flex-1 ms-3 whitespace-nowrap">Promos</span>
                                    </router-link>
                                </li>
                            ...
                            <!-- end teacher -->
                            <!-- student  -->
                            <div v-if="userAuthStore().role == 3">
                                <li>
                                    <router-link :to="{ name: 'studentClassrooms' }"
                                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                        <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                            viewBox="0 0 20 20">
                ...
                <div class="bg-gray-100 md:px-20 shadow-lg ">
                    ...
                    <div class="container mx-auto">
                        <div class="flex justify-between items-center py-4 px-2">
                            ...
                            <button @click="toggleSidebar" class="text-gray-500 hover:text-gray-600" id="open-sidebar">
