        ...
        <div
            ...
            <div class="sm:text-center lg:text-left">
                <h1 class="text-4xl tracking-tight font-extrabold text-gray-800 sm:text-5xl md:text-6xl">
                    <span class="block xl:inline">Empowering Tomorrow's Leaders: Welcome to </span>
                    <span class="block text-indigo-600 xl:inline">Your.School</span>
                </h1>
                <p
                    class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                    At Your.School, we inspire young minds and shape bright futures. With a focus on excellence in
                    education and a nurturing environment, we empower students to thrive. Join us as we embark on an
                    exciting journey of learning, growth, and endless possibilities.
                </p>
                <!-- Button Section -->
